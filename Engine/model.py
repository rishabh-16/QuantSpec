...
transformer_configs = {
    ...
    'llama-2-7b-32k-instruct': dict(block_size=32768, n_layer=32, dim= 4096, vocab_size=32000, scaling_factor=8),
    "LWM-Text-128K": dict(block_size=131072, n_layer=32, dim= 4096, vocab_size=32000, scaling_factor=1, rope_base=10000000.0, original_max_position_embeddings=131072),
    ...
    "LWM-Text-Chat-1M": dict(block_size=1048576, n_layer=32, dim= 4096, vocab_size=32000, scaling_factor=1, rope_base=50000000.0, original_max_position_embeddings=1048576),
    "llama-2-13b": dict(block_size=32768, n_layer=40, n_head=40, dim=5120),
    "longalpaca-13b": dict(block_size=4096, intermediate_size=13824, vocab_size=32001, n_layer=40, n_head=40, dim=5120, scaling_factor=8, original_max_position_embeddings=4096),  
    "llama-2-70b": dict(block_size=4096, n_layer=80, n_head=64, dim=8192, n_local_heads=8, intermediate_size=28672),
    "llama-2-70b-longlora-32k": dict(block_size=4096, n_layer=80, n_head=64, dim=8192, n_local_heads=8, intermediate_size=28672),
    ...
    "llama-3.1-8b-Instruct": dict(block_size=131072, n_layer=32, n_head=32, n_local_heads=8, dim=4096, intermediate_size=14336, vocab_size=128256, rope_base=500000.0, scaling_factor=8, high_freq_factor=4, low_freq_factor=1, original_max_position_embeddings=8192),
    ...
    "Mistral-7B-v0.3": dict(block_size=32768, n_layer=32, n_head=32, n_local_heads=8, dim=4096, intermediate_size=14336, vocab_size=32768, rope_base=1000000.0),
}
