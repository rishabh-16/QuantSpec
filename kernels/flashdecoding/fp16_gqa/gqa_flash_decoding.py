...
def token_decode_gqa_attention_flash_decoding(
    ...
    from .gqa_flash_decoding_stage1 import gqa_flash_decode_stage1
    from .gqa_flash_decoding_stage2 import gqa_flash_decode_stage2
    ...
    gqa_flash_decode_stage2(mid_o, mid_o_logexpsum, o_tensor.view(calcu_shape1), qcache_len, BLOCK_SEQ)
    return o_tensor
