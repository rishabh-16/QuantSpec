...
@triton.jit
def _fwd_kernel_int8kv_int8pack_flash_decode_stage1(
    Q, # query
...
@torch.no_grad()
def int8kv_int8pack_flash_decode_stage1(
    q,
    cache_quant_k, 
    cache_scale_k, 
    cache_min_k, 
    ...
    asm = _fwd_kernel_int8kv_int8pack_flash_decode_stage1[grid](
        q, 
